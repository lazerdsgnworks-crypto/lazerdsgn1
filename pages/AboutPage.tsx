    ...
    <div ref={pageRef} className="page-transition bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="text-center mb-20">
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tighter text-black">About LazerDsgn</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-black mb-4">Our Mission</h2>
          ...
          <div className="rounded-lg overflow-hidden shadow-lg">
            <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="Team collaborating" className="w-full h-full object-cover" />
          </div>
        </div>
        
        {/* --- Meet the Team Section --- */}
        <div className="text-center mb-20">
          <h2 className="text-3xl font-bold tracking-tight text-black mb-12">Meet the Team</h2>
